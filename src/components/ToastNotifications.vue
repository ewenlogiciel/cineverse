  ...
  <div class="fixed top-4 right-4 z-[9999] space-y-3 pointer-events-none">
    <TransitionGroup name="toast">
      <div
          ...
          :key="notification.id"
          class="pointer-events-auto rounded-lg overflow-hidden min-w-[300px] max-w-md"
...
const getNotificationClass = (type) => {
  const classes = {
    success: 'bg-gray-800/90 border-2 border-gray-600',
    error: 'bg-red-900/90 border-2 border-red-600',
    warning: 'bg-orange-900/90 border-2 border-orange-600',
    info: 'bg-gray-800/90 border-2 border-gray-600',
  }
